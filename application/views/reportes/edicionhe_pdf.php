...
<div class="caja">
  <div class="row cabecera">
    ...
    <label class="encabezado" >REPORTE DE HORAS EXTRAS Nº <?php echo $xd2 ?> (NO AUTORIZADO)</label>      
    </div>
  </div>  
</div>
<br>
...
<p style="color: red;">Nota: este reporte solo es válido a manera de visualización o comprobación.</p>
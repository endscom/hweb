...
<!-- Modal Structure DE AYUDA -->
  ...
  <div id="modal1" class="modal modal-fixed-footer">
    ...
    <form name="formulario2" action="<?php echo base_url('index.php/updatePass')?>" method="post">   
    ...
    <div class="modal-footer">
     <button  type="button" onclick="vamosaver()" class="modal-action waves-effect waves-green btn-flat ">ACEPTAR</button>
     ...
     <div class="collection">
             ...
             <div class="col l2"> <br></div>
                        ...
                        echo '
                              ...
                              <div class=" col l2 s12"><a href="'.base_url('index.php/horasextras').'" id="usuarios" class="collection-item activo boton ">GENERAR REPORTE</a></div>                        

                             <div class=" col l2 s12"><a href="'.base_url('index.php/vertodos').'" id="reportes" class="collection-item activo boton">EDITAR REPORTES</a></div>

                              <div class=" col l2 s12"><a href="'.base_url('index.php/autorizar').'" id="reportes" class="collection-item activo boton">REVISAR REPORTES</a></div>

                              <div class=" col l2 s12"><a href="'.base_url('index.php/verautorizados').'" id="reportes" class="collection-item activo boton">REPORTES REVISADOS</a></div>
...
if (/^\s*$/.test(texto))
  ...
  if (texto.length<8) 
      {alert("La contraseña debe tener al menos 8 caracteres");
        return false;}
  else{ document.formulario2.submit() 
      }
}
